...
wb=xlwt.Workbook()
#create a sheet
munci=['Manila','Makati','Mandaluyong','San Juan','Pasig','Pasay','Quezon','Taguig','Paranaque','North Caloocan','South Caloocan','Las Pinas','Malabon','Marikina','Navotas','Valenzuela','Muntinlupa']
for i in munci:
